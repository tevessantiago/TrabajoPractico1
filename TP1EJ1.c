...
int main()
{
	...
	int empleado, categoria, antiguedad, Sueldo, cantidadEmpleadosCategoria1, cantidadEmpleadosCategoria2, cantidadEmpleadosCategoria3, SueldosPorCategoria1, SueldosPorCategoria2, SueldosPorCategoria3, SueldoPromedio, SueldoMaximo;
	...
	for(empleado=0;empleado<3;empleado++)
    {
		...
		{
			SueldoMaximo = Sueldo;
			EmpleadoRico[20] = nombre[20];
		}
    }
	SueldoPromedio = (SueldosPorCategoria1 + SueldosPorCategoria2 + SueldosPorCategoria3) / (cantidadEmpleadosCategoria1 + cantidadEmpleadosCategoria2 + cantidadEmpleadosCategoria3);
	PorcentualCategoria1 = SueldosPorCategoria1 * 100 / SueldoMaximo;
	PorcentualCategoria2 = SueldosPorCategoria2 * 100 / SueldoMaximo;
	PorcentualCategoria3 = SueldosPorCategoria3 * 100 / SueldoMaximo;
